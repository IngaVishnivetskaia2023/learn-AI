...
## Hooks
PreToolUse hooks give you control over what Claude can do, while PostToolUse hooks let you enhance what Claude has done.

<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/79e17659-5fe7-4716-8fe4-d92612246a87" />
...
the `stdin` input to your command will differ significantly based upon the hook (`PreToolUse`, `PostToolUse`, `Stop`, etc) and the matcher used (in the case of `PreToolUse` and `PostToolUse`). This can make writing hooks challenging - you might not know the exact structure of the input to your command!
